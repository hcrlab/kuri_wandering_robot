...
tmux send-keys 'sudo service docker start || sudo docker run --rm --network host -v /home/mayfield/workspaces/nick_melodic_ws:/workspace -v /home/mayfield/.aws:/root/.aws -v /mayfield:/mayfield -it demo' Enter
